...
String password = request.getParameter("confirmPasswordName");
...
try (Connection conn = DriverManager.getConnection(connURL);
  ...
  if (!password.equals(userPassword)) {
    ...
    PreparedStatement pstmt2 = conn.prepareStatement("UPDATE customers SET first_name = ?, last_name = ? WHERE customer_id = ?");
